...
public class CIHDropAllSlot extends ContainersClickHandler {

    /**
     * For the use of {@link InventoryAction#PICKUP_HALF}
     */
    public CIHDropAllSlot() { super(InventoryAction.DROP_ALL_SLOT); }
    ...
    public ContainersInteractionResult handleContainersOperation(@Nullable GOOPCDeployed deployed, @Nullable ContainerInventory observed, @Nullable GOOPCPlayer rpg, @NotNull Player player, @NotNull InventoryClickEvent event) {
         ...
         *
         *   + The slot ends up with AIR
         */
        ItemStack finalStored = new ItemStack(Material.AIR);
        ...
        //CLI// OotilityCeption.Log("§8CONTAINERS §eDAS§a +§7 Dropping All " + OotilityCeption.GetItemName(GOOPCManager.cloneItem(event.getCurrentItem()), true));
